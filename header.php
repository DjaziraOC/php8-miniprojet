...
<!-- Activation des liens du menu Navbar-->
  <!-- Définissez la variable $index à true -->
...
<head>
    ...
    <link rel="canonical" href="/css/style.css/">
<!-- Appéler la bibliothèque jQuery -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<!-- Intégrer la datatable jquery -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.css" />
    <script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.js"></script>
<!-- Initialisation DataTables:pour le SEO c'est mieux de le fichier footer -->
