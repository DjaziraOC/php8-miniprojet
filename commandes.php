      ...
      ?>
        <tr>
          ...
          <td> 
            ...
            <a href="updatecommande.php?id=<?php echo $ligne["idcommande"]?>" class="btn btn-success">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  Voulez vous vraient supprimer cette commande?
                </div>
                <div class="modal-footer">
                  <a href="commandes.php" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</a>
                  <a href="deletecommande.php?idcommande=<?php echo $ligne["idcommande"]?>" type="button" class="btn btn-danger">Supprimer</a>
                </div>
              </div>
            </div>
          </div>
